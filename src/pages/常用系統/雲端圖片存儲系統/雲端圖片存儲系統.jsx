...
import './_雲端圖片存儲系統.scss';//引入指定樣式
import 雲端圖片系統架構 from './雲端圖片系統架構/雲端圖片系統架構';
import 雲端圖片前端頁面 from './前端/雲端圖片前端頁面';
import 雲端圖片伺服器端頁面 from './伺服器端/雲端圖片伺服器端頁面';



export default function 雲端圖片存儲系統() {
