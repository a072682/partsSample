...
export default function 資料表建立Dbeaver() {
  ...
  return (
    <div className="container">
        <div className="content-box">
            ...
            <br />
            <p className='fw-bold fs-20'>Name<span className='fw-normal'>:欄位名稱</span></p>
            <p className='fw-bold fs-20'>資料類型<span className='fw-normal'>:欄位的型別</span></p>
            <br />
            <p className='fw-bold fs-20'>身分<span className='fw-normal'>:是否為「自動流水號欄位」</span></p>
            <p> - 空白 = 普通欄位<br />
            ...
            <br />
            <p className='fw-bold fs-20'>整理<span className='fw-normal'>:排序規則</span></p>
            <p> 數字欄位 → 保持空白<br />
                文字欄位 → 一般用 default<br />
            ...
            <br />
            <p className='fw-bold fs-20'>是否為空<span className='fw-normal'>:欄位是否能是 NULL</span></p>
            <p>
                預設允許 NULL<br />
                若必填 → 勾選「不可為空」
            </p>
            ...
            <br />
            <p className='fw-bold fs-20'>預設<span className='fw-normal'>:欄位的預設值</span></p>
            <p> 文字：'active'<br />
                時間：now()<br />
                數字：0
            </p>
            ...
            <br />
            <p className='fw-bold fs-20'>Storage<span className='fw-normal'>:文字型別的儲存方式</span></p>
            <p>通常留空（使用預設 EXTENDED）</p>
            <p>等效資料庫指令:STORAGE EXTENDED(範例)</p>
            <br />
            <p className='fw-bold fs-20'>Unique:主鍵/唯一設定</p>
            ...
            <p>1.選擇目標的資料表</p>
            <p>2.選擇目標資料表的外鍵連接欄位</p>
            <p>3.選擇自己資料表中要連接外鍵的欄位</p>
            <p>4.點選ok這樣外鍵就建立完成了</p>
            <div>
